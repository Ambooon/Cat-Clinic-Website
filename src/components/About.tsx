    ...
    <section className="max-w-6xl mx-auto p-12">
      <div className="max-w-lg text-center mx-auto mb-16">
        ...
        <p className="font-light">
          ...
          exceptional veterinary care define us as a leading cat clinic in
          Philippines.
        </p>
      </div>
      ...
      <div className="grid lg:grid-cols-2">
        <div>
          <p className="mb-4 text-justify">
            At Gentle Paws Cat Care, we strive to create a purr-fect environment
            where your beloved feline companions receive the highest standard of
            care. Our mission is to promote the health, happiness, and longevity
            of cats through comprehensive veterinary services, compassionate
            staff, and a cat-friendly atmosphere.
          </p>
        ...
        <div className="hidden lg:flex flex-col gap-4 justify-between items-center px-12">
          <img
